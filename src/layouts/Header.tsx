...
const StyledH2 = styled.h2<{ underline: boolean }>(({ underline }) => ({
  ...
  return (
    <StyledHeader colors={colors}>
      <StyledH2 underline={path === "/"}>
        <Link color={colors.headerText} to="/" hovercolor={colors.headerHoverText}>
          Home
        </Link>
      </StyledH2>
      <StyledH2 underline={path.includes("blog")}>
        <Link color={colors.headerText} to="/blog" hovercolor={colors.headerHoverText}>
          Blog
        </Link>
      </StyledH2>
      <ThemeToggle />
